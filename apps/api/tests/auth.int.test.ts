...
describe('Authentication Integration Tests', () => {
  ...
  // describe('User Registration (409 - Conflict)', () => {
  //   test('409 on duplicate email', async () => {
  //     // First registration
  //     const res1 = await app.inject({
  //       method: 'POST',
  //       url: '/api/dashboard/register',
  //       payload: {
  //         email: 'test@example.com',
  //         password: 'password123',
  //         confirm_password: 'password123'
  ...
  //     const res = await app.inject({
  //       method: 'GET',
  //       url: '/api/dashboard/some-protected-route'
  //     })
  //     expect(res.statusCode).toBe(401)
  //     const body = res.json()
  ...
  // describe('Content-Type Validation (415)', () => {
  //   test('415 on unsupported content-type', async () => {
  //     const res = await app.inject({
  //       method: 'POST',
  //       url: '/api/dashboard/register',
