...
export function getBuiltInRules() {
    const rules = [
        ...
        { id: 'order_dedupe', name: 'Order Deduplication', description: 'Checks for potential duplicate orders based on customer and address data.', category: 'order', enabled: false, condition: 'metadata && metadata.is_duplicate_order === true', action: 'hold', priority: 14 },
